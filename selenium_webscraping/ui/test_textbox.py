...
def test_calendario_iteraction():
    ...
    calendario.click()
    time.sleep(2)
    driver.find_element(By.XPATH, "//*[@class='test_elementos-state-default' and text()='1']").click()
    time.sleep(2)
    calendario.click()
    driver.find_element(By.XPATH, "//*[@class='test_elementos-state-default' and text()='14']").click()
    time.sleep(2)
    calendario.clear()
